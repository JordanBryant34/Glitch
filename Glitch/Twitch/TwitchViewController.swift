...
class TwitchViewController: UIViewController {
    ...
    lazy var gamesController: TwitchGamesController = {
        let viewController = TwitchGamesController()
        return viewController
    }()
    
    lazy var followingController: TwitchFollowingController = {
        let viewController = TwitchFollowingController()
        return viewController
    }()
    ...
    override func viewDidLoad() {
        ...
        add(asChildViewController: gamesController)
    ...
    @objc private func handleSegmentChange() {
        if segmentControl.selectedSegmentIndex == 0 {
            ...
            remove(asChildViewController: gamesController)

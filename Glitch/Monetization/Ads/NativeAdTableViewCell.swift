...
class NativeAdTableViewCell: UITableViewCell {
    ...
    private func setupViews() {
        ...
        advertiserNameLabel.anchor(adLabel.topAnchor, left: adLabel.rightAnchor, bottom: adLabel.bottomAnchor, right: rightAnchor, topConstant: 0, leftConstant: 10, bottomConstant: 0, rightConstant: 10, widthConstant: 0, heightConstant: 0)
